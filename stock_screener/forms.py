...
class BacktestForm(forms.Form):
    ...
    days_to_buy = forms.IntegerField(label='Days to Complete a Buy Order', max_value=10, initial="0",
                                     widget=forms.NumberInput(attrs={'style': 'width:9ch'}))
    days_to_sell = forms.IntegerField(label='Days to Complete a Sell Order', max_value=10, initial="0",
                                      widget=forms.NumberInput(attrs={'style': 'width:9ch'}))
